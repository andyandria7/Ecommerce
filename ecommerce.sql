...
--
-- Host: localhost:3306
-- Generation Time: Aug 19, 2024 at 07:30 PM
...
INSERT INTO `categories` (`tcat_id`, `tcat_name`, `show_on_menu`) VALUES
(1, 'Men', 1),
(2, 'Women', 1),
(3, 'Kids', 1),
(4, 'Electronics', 1),
...
--
-- Table structure for table `end_categories`
--

CREATE TABLE `end_categories` (
...
--
-- Dumping data for table `end_categories`
--

INSERT INTO `end_categories` (`ecat_id`, `ecat_name`, `mcat_id`) VALUES
(1, 'Headwear ', 1),
(2, 'Sunglasses', 1),
(3, 'Watches', 1),
(4, 'Sandals', 2),
...
INSERT INTO `mid_categories` (`mcat_id`, `mcat_name`, `tcat_id`) VALUES
(1, 'Men Accessories', 1),
(2, 'Men\'s Shoes', 1),
(3, 'Beauty Products', 2),
(4, 'Accessories', 2),
...
(5, '2024_06_03_155657_create_sliders_table', 2),
(6, '2024_06_03_164107_create_products_table', 3);
...
INSERT INTO `products` (`p_id`, `p_name`, `p_old_price`, `p_current_price`, `p_qty`, `p_featured_photo`, `p_description`, `p_short_description`, `p_feature`, `p_condition`, `p_return_policy`, `p_total_view`, `p_is_featured`, `p_is_active`, `ecat_id`) VALUES
...
INSERT INTO `product_photos` (`pp_id`, `photo`, `p_id`) VALUES
(106, '106.jpg', 83),
(107, '107.jpg', 83),
(108, '108.jpg', 84),
(109, '109.jpg', 84),
...
INSERT INTO `users` (`id`, `name`, `lastname`, `email`, `phone`, `country`, `city`, `state`, `zip`, `password`, `photo`, `role`, `status`, `remember_token`, `created_at`, `updated_at`, `address`) VALUES
(7, 'aaaa', 'andy', 'andy7andria@gmail.com', '0000000000', 'USA', 'aaaa', 'azeaze', '123', '$2y$10$LAalIu0Lc3ZVd7hb2kf8W.a25PIcxM/ZSt9xJWhbKkvAwL0HSM7Pm', NULL, 'User', 'Active', NULL, '2024-06-03 16:49:23', '2024-06-03 16:49:23', 'lolo');
...
--
-- Indexes for table `end_categories`
--
ALTER TABLE `end_categories`
...
--
-- AUTO_INCREMENT for table `end_categories`
--
ALTER TABLE `end_categories`
...
--
ALTER TABLE `products`
  MODIFY `p_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;

--
-- AUTO_INCREMENT for table `product_photos`
--
ALTER TABLE `product_photos`
  MODIFY `pp_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
